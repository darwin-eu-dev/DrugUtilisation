...
#'
#' @param cohort Table in the cdm requires class `GeneratedCohortSet`
...
summariseDrugUse<- function(cohort,
  ...
  result <- summariseCohortDrugUse(
    cohort, strata, drugUseVariables, minimumCellCount
  )
...
#' }
drugUseColumns <- function(x) {
  colnames(x) [colnames(x) %in% c(
