---
title: "PaRe Report: DrugUtilisation [0.3.1]"
...
output:
  html_document:
    ...
    theme: cosmo
vignette: >
  %\VignetteIndexEntry{DrugUtilisation [0.3.1]}
...
tempDir <- tempdir()
pathToRepo <- file.path(tempDir, "DrugUtilisation")

git2r::clone(
  url = "https://github.com/darwin-eu/DrugUtilisation.git",
...
```{r checkDependencies, warning=FALSE, echo=FALSE, eval=FALSE}
