...
cdm$my_new_cohort <- cdm$my_cohort |>
  requirePriorDrugWashout(priorUseWashout = 365, cohortId = 2, name = "my_new_cohort")
cdm
...
- **washout**: `requirePriorDrugWashout(priorUseWashout = 365)`
- **minObs**: `requireObservationBeforeDrug(priorObservation = 365)`
