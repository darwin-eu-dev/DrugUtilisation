...
In this vignette we will introduce how to create a DrugUtilisation cohort. The cohort object is deffined in : `r vignette("cohorts", package = "omopgenerics")`
...
1.  `CDMConnector::generateConceptCohortSet()`: to generate a cohort for a certain
