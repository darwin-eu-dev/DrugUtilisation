...
The `summariseDrugRestart()` function analyzes the outcomes within a treatment cohort following the first exposure to a specific drug. It categorizes the events into four distinct groups:
