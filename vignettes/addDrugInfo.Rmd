---
title: "4. Add drug related information to a Drug Utilisation cohort"
author: "Martí Català, Mike Du, Yuchen Guo, Kim López-Güell, and Edward Burn"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{4. Add drug related information to a Drug Utilisation cohort}
...
The DrugUtilisation packages includes a range of functions that add
...
`addRoute()` function utilizes an internal CSV file containing all
