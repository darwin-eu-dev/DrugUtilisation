---
title: "Pare report: DrugUtilisation"
date: "`r Sys.Date()`"
output:
  html_document:
    toc: true
    ...
    theme: cosmo
vignette: >
  %\VignetteIndexEntry{Pare report: DrugUtilisation}
...
## Package overview
```{r packageDiagram, echo=FALSE, out.width="100%", warning=FALSE}
repo %>%
  PaRe::pkgDiagram() %>%
...
```{r getDefinedFunctionsPkg, echo=FALSE, message=FALSE, warning=FALSE}
...
### Summary
```{r lintScores, echo=FALSE, message=FALSE, warning=FALSE}
...
### Warnings
```{r lintMessagesWarnings, echo=FALSE, message=FALSE, warning=FALSE}
DT::datatable(
  lintMsgs %>%
...
### Style
```{r lintMessagesStyle, echo=FALSE, message=FALSE, warning=FALSE}
DT::datatable(
  lintMsgs %>%
...
```{r dependencyGraphStats, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r plotFunctionUse, echo=FALSE, dpi=100, fig.height=25, out.width="100%", message=FALSE, warning=FALSE}
